...
class calendarViewController: UIViewController {
    ...
    //var blockWidth :CGFloat! = 40
    //var blockSpacer :CGFloat! = 10
    //var numBlocks :CGFloat! = 10
    //var totalSpace :CGFloat! = 0
    
    var strDay :NSString! = ""
    var strMonth :NSString! = ""
    var strYear :NSString! = ""
    //var numDayOfWeek :CGFloat! = 0
    ...
    func layoutAMonth(strMonthNum: NSString, top: CGFloat) {
        ...
        //println("theDayOfWeek - start: \(theDayOfWeek)")
        
        //thePosX = (boxWWSpacer * theDayOfWeek) + self.margin
